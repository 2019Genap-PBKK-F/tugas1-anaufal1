    ...
    <div class="row">
      <div class="col-lg-12">
        <div>
          ...
          <div><input type="button" class="btn btn-primary" value="Tambah Data Mahasiswa" @click="() => spreadsheet.insertRow()" /></div>
          <hr>
        </div>
      </div>
    </div>
...
var data = [
  ['05111740000138', 'Ahmad Naufal H', '2017', '20/03/2000', '', true],
  ['05111740000777', 'Igris', '2018', '21/04/2001', '', true],
  ['05111740000999', 'Aqua', '2019', '22/05/2002', '', true]
]
var options = {
  data: data,
  allowToolbar: true,
